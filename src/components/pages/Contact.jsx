...
const Contact = () => {
  ...
  return (
    <div className="mb-20 relative" id="contact">    
    <div className="flex flex-col items-center mb-20">
      ...
      <div className="lg:pb-20 gap-4 grid lg:grid-cols-1" data-aos="zoom-out"
          data-aos-duration="1000">

      <div className="bg-slate-800 flex justify-start items-center gap-8 px-8 rounded-xl">
      <p className="text-4xl text-info"><FaAddressBook></FaAddressBook></p>
          <div>
        ...
        <div className="bg-slate-800 flex justify-start items-center gap-8 px-8 rounded-xl">
          <p className="text-4xl text-info"><FiPhoneCall/></p>
          <div>
        ...
        <div className="bg-slate-800 flex justify-start items-center gap-8 px-8 rounded-xl">
        <p className="text-4xl text-info"><MdEmail></MdEmail></p>
          <div>
